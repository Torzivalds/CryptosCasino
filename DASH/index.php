...
if (!empty($_POST['paymentID']) AND !empty($_POST['publicAdress'])) {
	...
	$req = $bdd->query("SELECT `Numero` FROM `DASH` WHERE 1 ORDER BY ID DESC LIMIT 1");
	$numeroPartieNow = 1;
	...
	$req = $bdd->prepare("INSERT INTO `DASH`(`WalletAdress`, `IDTransaction`, `Resultat`, `Numero`, `DateJeu`) VALUES (?, ?, ?, ?, ?)");
							...
							<article class="post featured">
								<header class="major">
									...
									<p>
										...
										Each player sends 0.13 DASH and tries to win 1.3 DASH!<br>
										It's not a question of luck, it's the 25th player who wins, then it starts from scratch, and starts again.</p>
								</header>
								<h2>You too, come play to try to win more than 1 Dash (1.3 DASH) !!</h2><br>
								<form method="post" action="index.php">
									<div id="deuxChamps">
										<p>
											Send 0.13 DASH to this adress :
											<input type="text" name="myAdress" placeholder="XcCYFd7hPtZ1rGKMqhK29PD3Fgk3E6bV7E" value="XcCYFd7hPtZ1rGKMqhK29PD3Fgk3E6bV7E">
										</p>
									...
									<h4>Enter your public Dash Adress :</h4>
									<input type="text" name="publicAdress" placeholder="Enter your public Dash adress" required>
									If you win, you will receive a Dash on this wallet.<br>
									<h6 style="font-style: italic;">If you send the form but the transaction you need to make is not done,<br>your Dash address may be banned from the site.</h6>
