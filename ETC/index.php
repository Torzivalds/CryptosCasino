...
if (!empty($_POST['paymentID']) AND !empty($_POST['publicAdress'])) {
	...
	$req = $bdd->query("SELECT `Numero` FROM `ETC` WHERE 1 ORDER BY ID DESC LIMIT 1");
	$numeroPartieNow = 1;
	...
	$req = $bdd->prepare("INSERT INTO `ETC`(`WalletAdress`, `IDTransaction`, `Resultat`, `Numero`, `DateJeu`) VALUES (?, ?, ?, ?, ?)");
							...
							<article class="post featured">
								<header class="major">
									...
									<p>
										...
										Each player sends 2.5 ETC and tries to win 2.50 ETC!<br>
										It's not a question of luck, it's the 25th player who wins, then it starts from scratch, and starts again.</p>
								</header>
								<h2>You too, come play to try to win 25 Ethereum Classic (25 ETC) !!</h2><br>
								<form method="post" action="index.php">
									<div id="deuxChamps">
										<p>
											Send 2.5 ETC to this adress :
											<input type="text" name="myAdress" placeholder="0xb46fe6b55aa733a65c2ecc131cf2fbf628d87619" value="0xb46fe6b55aa733a65c2ecc131cf2fbf628d87619">
										</p>
									...
									<h4>Enter your public Ethereum Classic Adress :</h4>
									<input type="text" name="publicAdress" placeholder="Enter your public Ethereum Classic adress" required>
									If you win, you will receive a Ethereum Classic on this wallet.<br>
									<h6 style="font-style: italic;">If you send the form but the transaction you need to make is not done,<br>your Ethereum Classic address may be banned from the site.</h6>
