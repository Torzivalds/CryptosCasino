...
if (!empty($_POST['paymentID']) AND !empty($_POST['publicAdress'])) {
	...
	$req = $bdd->query("SELECT `Numero` FROM `BCN` WHERE 1 ORDER BY ID DESC LIMIT 1");
	$numeroPartieNow = 1;
	...
	$req = $bdd->prepare("INSERT INTO `BCN`(`WalletAdress`, `IDTransaction`, `Resultat`, `Numero`, `DateJeu`) VALUES (?, ?, ?, ?, ?)");
							...
							<article class="post featured">
								<header class="major">
									...
									<p>
										...
										Each player sends 15000 BCN and tries to win 150000 BCN!<br>
										It's not a question of luck, it's the 25th player who wins, then it starts from scratch, and starts again.</p>
								</header>
								<h2>You too, come play to try to win 150k Bytecoin (150000 BCN) !!</h2><br>
								<form method="post" action="index.php">
									<div id="deuxChamps">
										<p>
											Send 15000 BCN to this adress :
											<input type="text" name="myAdress" placeholder="2AYBvWcWgJJC7MbZH6TWn66Zs6g2Kps1oFjuxtaXU5t4eUx71LcAe9vFr6MNqj3PGR4PGXzCGYQw7UemxRoRxCC97pd5q4X" value="2AYBvWcWgJJC7MbZH6TWn66Zs6g2Kps1oFjuxtaXU5t4eUx71LcAe9vFr6MNqj3PGR4PGXzCGYQw7UemxRoRxCC97pd5q4X">
										</p>
									...
									<h4>Enter your public Bytecoin Adress :</h4>
									<input type="text" name="publicAdress" placeholder="Enter your public Bytecoin adress" required>
									If you win, you will receive a Bytecoin on this wallet.<br>
									<h6 style="font-style: italic;">If you send the form but the transaction you need to make is not done,<br>your Bytecoin address may be banned from the site.</h6>
