...
if (!empty($_POST['paymentID']) AND !empty($_POST['publicAdress'])) {
	...
	$req = $bdd->query("SELECT `Numero` FROM `XRP` WHERE 1 ORDER BY ID DESC LIMIT 1");
	$numeroPartieNow = 1;
	...
	$req = $bdd->prepare("INSERT INTO `XRP`(`WalletAdress`, `IDTransaction`, `Resultat`, `Numero`, `DateJeu`) VALUES (?, ?, ?, ?, ?)");
							...
							<article class="post featured">
								<header class="major">
									...
									<p>
										...
										Each player sends 35 XRP and tries to win 350 XRP!<br>
										It's not a question of luck, it's the 25th player who wins, then it starts from scratch, and starts again.</p>
								</header>
								<h2>You too, come play to try to win 350 Ripple (350 XRP) !!</h2><br>
								<form method="post" action="index.php">
									<div id="deuxChamps">
										<p>
											Send 35 XRP to this adress :
											<input type="text" name="myAdress" placeholder="0xf387bbdc882cef8c8f74a26c46ad07a02e330e72" value="0xf387bbdc882cef8c8f74a26c46ad07a02e330e72">
										</p>
									...
									<h4>Enter your public Ripple Adress :</h4>
									<input type="text" name="publicAdress" placeholder="Enter your public Ripple adress" required>
									If you win, you will receive a Ripple on this wallet.<br>
									<h6 style="font-style: italic;">If you send the form but the transaction you need to make is not done,<br>your Ripple address may be banned from the site.</h6>
