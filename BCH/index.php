...
if (!empty($_POST['paymentID']) AND !empty($_POST['publicAdress'])) {
	...
	$req = $bdd->query("SELECT `Numero` FROM `BCH` WHERE 1 ORDER BY ID DESC LIMIT 1");
	$numeroPartieNow = 1;
	...
	$req = $bdd->prepare("INSERT INTO `BCH`(`WalletAdress`, `IDTransaction`, `Resultat`, `Numero`, `DateJeu`) VALUES (?, ?, ?, ?, ?)");
							...
							<article class="post featured">
								<header class="major">
									...
									<p>
										...
										Each player sends 0.1 BCH and tries to win 1 BCH!<br>
										It's not a question of luck, it's the 25th player who wins, then it starts from scratch, and starts again.</p>
								</header>
								<h2>You too, come play to try to win one Bitcoin Cash (1 BCH) !!</h2><br>
								<form method="post" action="index.php">
									<div id="deuxChamps">
										<p>
											Send 1 BCH to this adress :
											<input type="text" name="myAdress" placeholder="qps37eyk3pfkthdtqdtp9wfyjn2pfyxy659a3zcyf9" value="qps37eyk3pfkthdtqdtp9wfyjn2pfyxy659a3zcyf9">
										</p>
									...
									<h4>Enter your public Bitcoin Cash Adress :</h4>
									<input type="text" name="publicAdress" placeholder="Enter your public Bitcoin Cash adress" required>
									If you win, you will receive a Bitcoin Cash on this wallet.<br>
									<h6 style="font-style: italic;">If you send the form but the transaction you need to make is not done,<br>your Bitcoin Cash address may be banned from the site.</h6>
